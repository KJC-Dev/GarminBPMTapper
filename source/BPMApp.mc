...
class BPMView extends Ui.View
{
    ...
    {   
        ...
        if (consistency[0] > 0) {
            ...
            dc.drawText( (dc.getWidth() / 2), (dc.getHeight() / 2) - 20, Gfx.FONT_NUMBER_THAI_HOT, bpmString, Gfx.TEXT_JUSTIFY_CENTER );
            ...
            dc.drawText( (dc.getWidth() / 2) + 57, Gfx.getFontHeight(Gfx.FONT_MEDIUM)+3, Gfx.FONT_MEDIUM, timerString, Gfx.TEXT_JUSTIFY_CENTER | Gfx.TEXT_JUSTIFY_VCENTER );
            
        } else {
            // display startup info
            var tapMsg = "Tap for tempo";
            dc.drawText( (dc.getWidth() / 2), (dc.getHeight() / 2) + 10 - Gfx.getFontHeight(Gfx.FONT_MEDIUM), Gfx.FONT_MEDIUM, tapMsg, Gfx.TEXT_JUSTIFY_CENTER );
            var holdMsg = "Hold to reset";
            dc.drawText( (dc.getWidth() / 2), (dc.getHeight() / 2) + 10, Gfx.FONT_MEDIUM, holdMsg, Gfx.TEXT_JUSTIFY_CENTER );
        }
